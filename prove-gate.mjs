...
const BREAKS = [
    ...
    ["the nav stacking breakpoint moved without the record", "rebuild", (d) => edit(d, "src/shell.css", "@media(max-width:720px){.top{flex-direction:column", "@media(max-width:430px){.top{flex-direction:column"),
    ...
    ["the animation inserting its sprite into the document", "gate", (d) => edit(d, "memory.js", "return c;", "document.body.append(c);\nreturn c;"),
     "never writes append"],
    ["an animation constant published as a number", "gate", (d) => edit(d, "index.html", "<h2>From a pinned registry", "<h2>Now with 27 of them. From a pinned registry"),
